...
struct ContentView: View {
    ...
    var body: some View {
        // holds everything plus background image
        ZStack {
            Image("background")
                .resizable()
                .ignoresSafeArea()
            // holds stack of cards and timer
            VStack {
            ...
            if differentiateWithoutColor || voiceOverEnabled {
                VStack {
                    ...
                    HStack {
                        ...
                        .accessibilityHint("Answer incorrect")
                        Spacer()
                        Button {
                            withAnimation {
                        ...
                        .accessibilityHint("Answer correct")
                    }
                    .foregroundColor(.white)
                    .font(.largeTitle)
                    .padding()
